...
public class SetLocationCmd implements SubCommand {
    ...
    public boolean onCommand(final CommandSender sender, final String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (var2 == null) {
                Utils.sendMessage(sender, "messages.commands.setlocation.notExist");
                return true;
            }
    ...
    @Override
    public String help() {
        return Utils.getConfig().getString("messages.commands.setlocation.help").replace("%alias%", "fholo");
    }
